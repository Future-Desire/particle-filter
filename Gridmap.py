...
class Gridmap(object):
    ...
    def __init__(self, occupancy, xres=1, yres=1):
        ...
        ----------
        occupancy :   An occupancy grid-based representation of the environment (numpy.array)
        xres :  The resolutions of the map in the x-directions (optional, default: 1)
        yres :  The resolutions of the map in the y-directions (optional, default: 1)
    ...
    def getShape(self):
        """
        Returns the height and width of the occupancy grid in terms of the number of cells.
